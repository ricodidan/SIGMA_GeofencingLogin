...
public class GeofenceTransitionsIntentService extends IntentService {
    ...
    private void sendNotification(String notificationDetails) {
        ...
        Intent notificationIntent = new Intent(getApplicationContext(), ProfilActivity.class);
        ...
        if (sharedpreferencesnotif.contains(Det)) {
            notificationDetails.toString();
        }

        String n = notificationDetails.toString();
        SharedPreferences.Editor editor = sharedpreferencesnotif.edit();
        editor.putString(Det, n);
        editor.commit();
